...
#include "gui/imgui/stb_textedit.h"
...
namespace ImGui
{
    ...
    IMGUI_API void          PlotEx_xy(ImGuiPlotType plot_type, const char*label, float (*values_getter)(void* data, int idx), void* data, void* data2,
