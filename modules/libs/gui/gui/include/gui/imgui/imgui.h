...
#include "gui/imgui/imconfig.h"       // User-editable configuration file
#endif
...
namespace ImGui
{
    ...
    IMGUI_API void          PlotLinesXY(const char* label, const float*values, const float*values2,int values_count, int values_offset = 0, const char* overlay_text = NULL, float scale_min = FLT_MAX, float scale_max = FLT_MAX, ImVec2 graph_size = ImVec2(0,0), int stride = sizeof(float));
